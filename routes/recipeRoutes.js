...
router.get('/recipes', async (req, res) => {
  try {
    ...
    const formattedRecipes = recipes.map((recipe) => ({
      ...
      createdAt: recipe.createdAt, // Include createdAt in the response
      user: {
        id: recipe.user._id, // Include user details
...
router.get('/recipes/:id', async (req, res) => {
  try {
    ...
    res.json({
      ...
      createdAt: recipe.createdAt, // Include createdAt
      user: {
        id: recipe.user._id, // Include user details
        name: recipe.user.name,
        email: recipe.user.email,
...
router.post('/recipes', authenticate, async (req, res) => {
  ...
  try {
    ...
    const newRecipe = new Recipe({
      ...
      user: userId, // Assign the authenticated user as the owner
